...
const steps = ['Basic Information', 'Contact Details', 'Eductional Details', 'skills And Summary'];
...
function UserInputs() {
    ...
    const renderStepContent = (stepcount) => {
       ...
       case 0 : return(
        ...
        <TextField id="standard-basic-year" label="Year of Graduction" variant="standard" />
            </div>
        </div>
       )
        case 3 : return(
        <div className='p-3 row'>
           <h6>Our AI will generate Skills and Summary according to Job Jole. Click The <b>AI Skills & Summary</b>button to proceed</h6>
        </div>
       )
       default: return null
        }
        ...
        <Box sx={{ width: '100%' }}>
            ...
            {activeStep === steps.length ? (
                ...
                <React.Fragment>
                    ...
                    {/* render form according to active step count */}
                    <Box>
                        {
